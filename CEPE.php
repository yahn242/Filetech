            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="CEPE.php">CEPE</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Demande de retrait du CEPE </h1>
                        ...
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4">
                                ...
                                <form class="container" >
                                  ...
                                  <div class="mb-3">
                                  <input type="text" class="container" name="description" placeholder="Diplôme du CEPE" required disabled />
                                  </div>
                                  
                                  
                                  <a class="container  btn btn-primary m-a" href="CEPEFormulaire.php">
                                  Etape suivante
                                  </a>

            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="BEPCgeneral.php">BEPC</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Demande de retrait du BEPC Général</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                <h6 class="m-0 font-weight ">Procedure *</h6>
                                <!-- Divider -->
                                <hr class="sidebar-divider my-0">
                                <br>
                                ...
                                <form class="container" >
                                  ...
                                  <div class="mb-3">
                                  <input type="text" class="container" name="description" placeholder="Diplôme du BEPC" required disabled />
                                  </div>
                                  
                                  
                                  <a class="container  btn btn-primary m-a" href="BepcGeneralFormulaire.php">
                                  Etape suivante
                                  </a>

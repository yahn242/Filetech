            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">FILETECH</h1>
                                   
                    </div>
                
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                   
                        <h2 class="h6 mb-0 text-gray-800 ">La procédure de demande de retrait du diplôme est ouverte à toute personne physique admise aux différents examens et concours.</h2>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Qui peut  faire la demande ?</h6>
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                <h6 class="m-0 font-weight ">Tout citoyen ayant obtenu le BAC Général - BAC Technique - BEPC - BET - CEPE </h6>
                                </div>
                            </div>
                        </div>
                        <!-- Area Chart -->
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4 ">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Quels sont les documents à présenter ?</h6>
                                    <div class="dropdown no-arrow">
                                ...
                                <!-- Card Body -->
                                <div class="card-body ">
                                <h6 class="m-0 font-weight ">Photocopie de l'acte de naissance ou la pièce d'identité du candidat</h6>
                                </div>
                            </div>
                        </div>

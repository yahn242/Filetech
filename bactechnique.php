            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner  rounded ">
                        ...
                        <a class="collapse-item active" href="bactechnique.php">BAC</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Demande de retrait du BAC Technique</h1>
                        ...
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4">
                                ...
                                <form class="container" >
                                  ...
                                  <a class="container  btn btn-primary m-a" href="BacTechniqueFormulaire.php">
                                  Etape suivante
                                  </a>

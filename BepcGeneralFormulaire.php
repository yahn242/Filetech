...
if (isset($_POST) & !empty($_POST)){
    ...
    $image= ($_POST['image']);
    $createSql = "INSERT INTO `dipbepc`  (nom, prenom , Dnaissance , Netablissement , Anneeobtention ,src) 
...
?>
    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="BEPCgeneralphp">BEPC</a>
        ...
        <div class="mb-3">
            <label for="input1" class="form-label">Année d'obtention du Bepc</label>

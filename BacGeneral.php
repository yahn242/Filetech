            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Demande de retrait du BAC Général</h1>
                        ...
                        <div class="col-xl-8 col-lg-7 container">
                            <div class="card shadow mb-4">
                                ...
                                <form class="container" >
                                  ...
                                  <div class="mb-3">
                                  <input type="text" class="container" name="description" placeholder="Diplôme du BAC" required disabled />
                                  </div>
                                  
                                  
                                  <a class="container  btn btn-primary m-a" href="BacGeneralFormulaire.php">
                                  Etape suivante
                                  </a>
